...
## 8. Coherencia Integral del Proyecto

| Componente | Conexión |
|-----------|----------|
| **Problema de negocio** | Fondo busca ROI en alquiler; maximizar ingreso relativo a precio |
| **Preguntas analíticas** | Descriptivo → diagnóstico → predictivo → prescriptivo |
| **Hipótesis** | Causalidad clara; evitar confusión multicausal (excepto donde se reconoce) |
| **KPIs** | Miden directamente objetivo (rentabilidad, payback, precio/renta) |
| **Datos** | Inmobiliarios + contextuales relevantes (transporte, delito como segmentación) |
| **Análisis esperado** | EDA por zona/tipología → modelos predictivos de renta → simulaciones ROI por estrategia |
| **Conclusiones** | Recomendaciones: "Invertir en X barrio, tipología Y, estrategia Z porque rentabilidad es W%" |

---

## 9. Próximos Pasos (Pre-entrega 2)

1. **Limpieza de datos inmobiliarios:** Validación de valores, estandarización
2. **Geocodificación de propiedades:** Mapeo a comuna y coordenadas
3. **Integración de datos contextuales:** Joins con delitos, subte, espacios verdes
4. **EDA por nivel:**
   - Descriptivo: distribuciones de precio, renta, características
   - Diagnóstico: correlaciones entre características y precio/renta
   - Validación gráfica de hipótesis principales (H2, H3, H4, H6)
5. **Construcción de modelos predictivos básicos:** Regresión de renta en función de características
6. **Análisis de rentabilidad:** Cálculo de payback period por zona/tipología

---

**Equipo:** Kiara Natale, Gonzalo Haro, Justo Celsi  
